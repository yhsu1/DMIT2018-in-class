<Query Kind="Statements">
  <Connection>
    <ID>d24f9029-95d1-46b2-82c4-ff952c6a4133</ID>
...
// 0) Set up info that might be passed in to my bill
var month = DateTime.Today.Month - 1;  // previous
...
var billsInMonth = from item in Bills
				   where item.PaidStatus // Only the bills that were/are oaid
